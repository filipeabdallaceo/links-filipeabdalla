...
export function Avatar() {
  return (
    <div className="relative">
      ...
      <div className="absolute -bottom-0.5 -right-0.5 sm:-bottom-1 sm:-right-1 h-3.5 w-3.5 sm:h-6 sm:w-6 rounded-full bg-[#03A0CD] ring-2 sm:ring-4 ring-[#000000] flex items-center justify-center">
        <svg viewBox="0 0 24 24" className="h-2 w-2 sm:h-3.5 sm:w-3.5 fill-white" aria-hidden>
